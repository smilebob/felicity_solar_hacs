...
- Maintained and extended by **[Pierre / @smilebob](https://github.com/smilebob)** (Smilebob Edition).
- Original Home Assistant integration by **[Matheus Tavares Trindade / @matheustavarestrindade](https://github.com/matheustavarestrindade)**.
- Lithium battery telemetry enhancements contributed by **[Fábio Matavelli / @fabiomatavelli](https://github.com/fabiomatavelli)**.
