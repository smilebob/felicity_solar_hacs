...
| [`sensors_battery.py`](file:///home/pierre/Projets/felicity_solar_hacs/custom_components/felicity_solar/sensors_battery.py) | Battery Sensors (48) | Voltage, current, SOC, SOH, individual cell voltages 1–16 (mV with V/mV auto-detect & dynamic availability for 15S/16S), cell min/max mV & probe IDs, dV Cells (mV), cell temps (1-4), BMS charge/discharge current limits, cell count, battery type, connected inverter SN |
