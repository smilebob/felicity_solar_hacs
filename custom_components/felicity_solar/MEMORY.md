...
| [`sensors_inverter.py`](file:///home/pierre/Projets/felicity_solar_hacs/custom_components/felicity_solar/sensors_inverter.py) | Inverter Sensors (74) | Battery power, charge/discharge decomposition, energies (PV, load, battery), backup L1-L3, grid L1-L3, generator, temperatures, BMS flag, warnings |
